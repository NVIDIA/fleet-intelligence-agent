...
// InjectFault injects a fault into the clock-speed component by replacing the getClockSpeedFunc
func (c *component) InjectFault(errMsg string) {
	c.getClockSpeedFunc = func(uuid string, dev device.Device) (ClockSpeed, error) {
		return ClockSpeed{}, errors.New(errMsg)
	}
}

// ClearFault clears any injected faults and restores the original clock speed checking function
func (c *component) ClearFault() {
	c.getClockSpeedFunc = GetClockSpeed
}
