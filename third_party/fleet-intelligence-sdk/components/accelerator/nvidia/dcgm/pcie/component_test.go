...
func TestCheck(t *testing.T) {
	...
	if err := dcgmFieldValueCache.SetupFieldWatchingWithName("gpud-pcie-fields"); err != nil {
	...
	// Look for our PCIe metrics
	pcieMetricsFound := map[string]int{
