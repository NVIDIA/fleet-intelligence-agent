...
import (
	...
	infinibandstore "github.com/NVIDIA/fleet-intelligence-sdk/components/accelerator/nvidia/infiniband/store"
...
func New(gpudInstance *components.GPUdInstance) (components.Component, error) {
	...
	c := &component{
		...
		getClassDevicesFunc: func(ignoreFiles map[string]struct{}) (infinibandclass.Devices, error) {
			...
			// ref. https://github.com/NVIDIA/fleet-intelligence-sdk/issues/1164
...
// InjectFault injects a fault into the infiniband component
...
func (c *component) ClearFault() {
	...
	c.getClassDevicesFunc = func(ignoreFiles map[string]struct{}) (infinibandclass.Devices, error) {
		...
		if len(c.toolOverwrites.ExcludedInfinibandDevices) > 0 {
			opts = append(opts, infinibandclass.WithExcludedDevices(c.toolOverwrites.ExcludedInfinibandDevices))
		}
		return infinibandclass.LoadDevices(c.toolOverwrites.InfinibandClassRootDir, opts...)
	}
}
...
func (c *component) InjectEvent(name, eventType, message string) error {
	if c.eventBucket == nil {
		return errors.New("InfiniBand component has no event bucket")
	}
