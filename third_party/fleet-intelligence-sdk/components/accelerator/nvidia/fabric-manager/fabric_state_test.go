...
import (
	...
	devwrap "github.com/NVIDIA/fleet-intelligence-sdk/pkg/nvidia-query/nvml/device"
	nvmltestutil "github.com/NVIDIA/fleet-intelligence-sdk/pkg/nvidia-query/nvml/testutil"
)
