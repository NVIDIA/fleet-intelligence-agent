...
func (c *component) InjectFault(errMsg string) {
	c.getECCErrorsFunc = func(uuid string, dev device.Device, eccModeEnabledCurrent bool) (ECCErrors, error) {
		return ECCErrors{}, errors.New(errMsg)
	}
}
...
func (c *component) ClearFault() {
	...
	c.getECCErrorsFunc = GetECCErrors
}
