...
// ClearFault restores the original virtual memory function
func (c *component) ClearFault() {
	c.getVirtualMemoryFunc = mem.VirtualMemoryWithContext
}

// InjectEvent injects an event into the memory component's event bucket
