...
// InjectFault injects a fault into the containerd component
...
func (c *component) ClearFault() {
	...
	c.checkDependencyInstalledFunc = checkContainerdInstalled
	c.checkSocketExistsFunc = CheckSocketExists
	c.checkServiceActiveFunc = func(ctx context.Context) (bool, error) {
		return systemd.IsActive("containerd")
	}
	c.checkContainerdRunningFunc = CheckContainerdRunning
	c.listAllSandboxesFunc = ListAllSandboxes
}
