...
// ClearFault restores the original CPU checking functions
func (c *component) ClearFault() {
	c.getTimeStatFunc = getTimeStatForAllCPUs
}

// InjectEvent injects an event into the CPU component's event bucket
