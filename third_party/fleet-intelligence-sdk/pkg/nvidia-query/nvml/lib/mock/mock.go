	...
	DeviceGetHandleByIndexFunc: func(n int) (nvml.Device, nvml.Return) {
		return &nvmlmock.Device{
			...
			GetPlatformInfoFunc: func() (nvml.PlatformInfo, nvml.Return) {
				// Chassis serial is a fixed-size byte array in NVML; store a null-terminated string.
				var pi nvml.PlatformInfo
				copy(pi.ChassisSerialNumber[:], []byte("1583425610002"))
				return pi, nvml.SUCCESS
			},
