...
func TestDefaultFsTypeFuncs(t *testing.T) {
	...
	t.Run("DefaultExt4OrXfsFsTypeFunc", func(t *testing.T) {
		assert.True(t, DefaultExt4OrXfsFsTypeFunc("ext4"))
		assert.True(t, DefaultExt4OrXfsFsTypeFunc("xfs"))
		assert.False(t, DefaultExt4OrXfsFsTypeFunc("fuse.juicefs"))
		assert.False(t, DefaultExt4OrXfsFsTypeFunc(""))
	})
	...
	t.Run("DefaultFsTypeFunc", func(t *testing.T) {
		...
		assert.True(t, DefaultFsTypeFunc("xfs"))
		...
		assert.True(t, DefaultFsTypeFunc("nfs"))
		assert.True(t, DefaultFsTypeFunc("nfs4"))
