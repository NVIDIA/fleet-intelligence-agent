	...
	return &backendclient.NodeUpsertRequest{
		...
		Resources: backendclient.NodeResources{
			...
			GPUInfo: backendclient.GPUInfo{
				...
				VisibleGPUCount: s.Resources.GPUInfo.VisibleGPUCount,
				NVMLDegraded:    s.Resources.GPUInfo.NVMLDegraded,
				NVMLErrors:      append([]string(nil), s.Resources.GPUInfo.NVMLErrors...),
				GPUs:            gpus,
			},
